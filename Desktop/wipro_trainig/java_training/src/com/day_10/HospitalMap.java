...
class patients{
	...
	public patients(String id, String name, String disease) {
		this.id = id;
		this.name=name;
    ...
    public String toString() {
        return "ID: " + id + ", Name: " + name + ", Report: " + disease;
    }
	...
	public static void main(String[] args) {
		...
		while(true) {
            ...
            case 2:
                ...
                String retrieveId = sc.nextLine();
                
                if (patientMap.containsKey(retrieveId)) {
                    System.out.println(patientMap.get(retrieveId));
                } else {
            ...
            case 3:
                ...
                if (patientMap.containsKey(deleteId)) {
                    patientMap.remove(deleteId);
            ...
            case 5:
                ...
                Patient updatePatient = patientMap.get(updateId);
                if (updatePatient != null) {
                    System.out.print("Enter New Disease/Report: ");
                    String newDisease = sc.nextLine();
                    updatePatient.setDisease(newDisease);
                    System.out.println("Patient report updated.");
                } else {
                    System.out.println("Patient not found.");
                }
                break;
