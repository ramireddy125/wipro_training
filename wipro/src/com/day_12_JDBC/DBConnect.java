...
public class DBConnect {
	...
	public static void main(String[] args) {
		...
		patientUpdateList.add(new patients("chari ayyangar", 22, "fever"));
		patientUpdateList.add(new patients("aarumulla ravgava", 26, "cold"));
...
//			System.out.println(" All Patients details inserted");
			...
			String update = "UPDATE PATIENT SET nane=? WHERE nane=?";
...
//			int rowsUpdated=pstmt.executeUpdate();
			...
			{
			   System.out.print("Enter the old name to update: ");
